...
# ╔═╡ 4e0e36d2-f1ef-49ea-b575-663aeb8eecb6
using CairoMakie

# ╔═╡ f862aa8e-3822-46bb-853e-2c6aa10b5ae7
using DifferentialEquations

# ╔═╡ e5025e7a-4ac0-42f2-8755-4bcb5a3686f5
md"""
# fazendo um plot muito simples
"""

# ╔═╡ f57c310d-59fc-458a-b298-e63941d46b4f
f(x) = x*sin(2*π*x)^2

# ╔═╡ 43cc87d6-fdd4-4c25-8184-032623159659
begin
	x = 0:0.01:1
	y = f.(x)
end

# ╔═╡ ce72f6d3-37cb-4b92-a155-cdf734fac8aa
begin
	f1 = Figure(resolution=(600,300))
	ax = Axis(f1[1, 1],
		xlabel="x",
		ylabel="y",
		title="f(x)"
	)
	lines!(ax, x,y, label="label qualquer", color=:red)
	#save("tentar.svg", f1)
	f1
end

# ╔═╡ 40658035-1f47-4497-b954-6380a2c7ca8e
md"""
Vamos ao que interessa...
"""

# ╔═╡ bb8d8272-458d-475f-b1f6-8c2f520808d7
md"""
# Equações Diferenciais Ordinárias
"""

# ╔═╡ 42730e6d-86a8-4a5b-9c74-d1a454269c4c
md"""
# Definindo o problema

$\frac{dξ}{dt} = A \sin(2 \pi t /T)$
"""

# ╔═╡ 107f0419-3003-44ee-a02a-006a488636db
md"""
a função que define a EDO 1 ordem
"""

# ╔═╡ 18f1ae4c-d270-4ad2-8b85-2feb6898b1c2
function dξ(u, p, t)
	A, T = p
	# A = p[1]
	# T = p[2]
	return A*t*sin(2*π*t/T)^4
end

# ╔═╡ 37351e7a-9144-4a0d-8832-f657434cce76
begin
	u0=0
	p = [1.0, 2.0]
	tspan = (0.0, 2.0)
	problema = ODEProblem(dξ, u0, tspan,p)
end

# ╔═╡ ac8f5244-33c6-435e-97c2-f6b9678c94bf
solucao = solve(problema, Tsit5())

# ╔═╡ aa1ea43a-f5ba-4400-ac50-6ec83e0769ca


# ╔═╡ c89c65c7-61d0-4173-877d-eb8cd5550a45
begin
	f2, ax2 = scatter(solucao.t, solucao.u)
	
	tempo = 0:0.001:2
	lines!(ax2, tempo, solucao.(tempo))
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "a429659bac4216383954c78e91578c0f82468c09"
